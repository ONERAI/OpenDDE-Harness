...
def test_manifest_parses_data_contributions():
    ...
    assert mf.contributes.tool_description_notes == {"bash": "Demo note."}
...
def test_registry_exposes_data_contributions(tmp_path):
    ...
    assert registry.tool_description_note("bash") == "Demo note."
    assert registry.tool_description_note("read") == ""
...
def test_registry_orders_contributions_by_plugin_id(tmp_path):
    ...
    assert registry.tool_description_note("bash") == "Demo note. Demo note."
