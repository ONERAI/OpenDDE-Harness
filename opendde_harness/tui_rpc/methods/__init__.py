...
from opendde_harness.tui_rpc.methods.approval import register_approval_methods
from opendde_harness.tui_rpc.methods.cli_dispatch import register_cli_methods
...
from opendde_harness.tui_rpc.methods.session import register_session_methods
from opendde_harness.tui_rpc.methods.setup import register_setup_methods
from opendde_harness.tui_rpc.methods.slash_routing import register_slash_routing_methods
from opendde_harness.tui_rpc.methods.system import register_system_methods
from opendde_harness.tui_rpc.methods.terminal import register_terminal_methods
...
def register_aligned_methods_except_system(
    ...
    *,
    ...
    the demo runner but not in ``ddeharness tui`` subprocess.
    """
